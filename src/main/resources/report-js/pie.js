...
function drawPieChart(passNum,failNum,naNum,elemId) {
        var canvas = document.getElementById(elemId);
        var seriesData = [{name:"PASS", value:passNum, color:"#1AE66B"},
                      {name:"FAIL", value:failNum, color:"#FF6600"},
                      {name:"N/A", value:naNum, color:"#D5D5D5"}]
        var config = {
                width : 500, 
                height: 320,
                series: seriesData,
